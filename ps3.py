...
def get_word_score(word, n):
    ...
    second_com = (7 * word_length - 3 * (n - word_length))
    word = word.lower()
    ...
    for i in word:
        if i in SCRABBLE_LETTER_VALUES:
            ...
            first_com = first_com + value


    score = first_com * second_com 
...
def is_valid_word(word, hand, word_list):
    ...
    #Check if word in the suggested word list
    ...
    for key, value in word_freq.items():
        if value > hand_copied.get(key, 0):
            return False
...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    if calculate_handlen(hand) == 0:
        print("Ran out of letters. Total score:", end="")
    ...
    while True:
        ...
        if not letter_substituted:
            ...
            if substitute.lower() == "yes":
                ...
                hand_score += get_word_score(letter, n)
